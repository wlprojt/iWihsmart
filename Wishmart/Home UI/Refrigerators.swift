...
struct RefrigeratorsSection: View {

    @StateObject private var vm = RefrigeratorViewModel()
                    ...
                    HStack(spacing: 16) {
                        ForEach(vm.products) { p in
                            Button {
                                ...
                                RefrigeratorProductCard(product: p)
                            }
                            .buttonStyle(.plain)
                        }
                    }
...
private struct RefrigeratorProductCard: View {
    let product: Product
