...
struct AirConditionerSection: View {

    @StateObject private var vm = AirConditionerViewModel()
                    ...
                    HStack(spacing: 16) {
                        ForEach(vm.products) { p in
                            Button {
                                ...
                                AirConditionerProductCard(product: p)
                            }
                            .buttonStyle(.plain)
                        }
                    }
...
private struct AirConditionerProductCard: View {
    let product: Product
