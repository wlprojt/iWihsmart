...
struct HomeAppliancesSection: View {

    @StateObject private var vm = HomeAppliancesViewModel()
                    ...
                    HStack(spacing: 16) {
                        ForEach(vm.products) { p in
                            Button {
                                ...
                                HomeAppliancesProductCard(product: p)
                            }
                            .buttonStyle(.plain)
                        }
                    }
...
private struct HomeAppliancesProductCard: View {
    let product: Product
