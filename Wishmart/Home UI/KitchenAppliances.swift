...
struct KitchenAppliancesSection: View {

    @StateObject private var vm = KitchenAppliancesViewModel()
                    ...
                    HStack(spacing: 16) {
                        ForEach(vm.products) { p in
                            Button {
                                ...
                                KitchenAppliancesProductCard(product: p)
                            }
                            .buttonStyle(.plain)
                        }
                    }
...
private struct KitchenAppliancesProductCard: View {
    let product: Product
